...
public class AuthenticationHandler {
    ...
    public static UserIdentity authenticate(ConnectContext context, String user, String remoteHost, byte[] authResponse)
        ...
        System.out.println("authenticate user:"+user+" remoteHost:"+remoteHost);
    ...
    private static AuthenticationResult authenticateWithNative(ConnectContext context, String user, String remoteHost,
                                                               byte[] authResponse)
            throws AuthenticationException {
        System.out.println("authenticateWithNative user:"+user);
        ...
        System.out.println("authenticateWithNative matchedUserIdentity:"+matchedUserIdentity);
        if (matchedUserIdentity == null) {
            ...
            System.out.println("authenticateWithNative provider:"+provider);
