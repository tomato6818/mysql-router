...
public class MysqlPassword {
    ...
    public static boolean checkScramble(byte[] scramble, byte[] message, byte[] hashStage2) {
        ...
        System.out.println("checkScramble");
        try {
        ...
        System.out.println("checkScramble candidateHash2:" + Arrays.toString(candidateHash2));
        System.out.println("checkScramble hashStage2:" + Arrays.toString(hashStage2));
    ...
    public static boolean checkScrambledPlainPass(byte[] savedScrambledPass, byte[] scrambledPlainPass) {
        System.out.println("checkScrambledPlainPass");
