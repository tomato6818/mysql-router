...
public class MysqlHandshakePacket extends MysqlPacket {
    ...
    public void writeTo(MysqlSerializer serializer) {
        ...
        if (capability.isPluginAuth()) {
            System.out.println("MysqlHandshakePacket capability.isPluginAuth()");
        ...
        if (capability.isSecureConnection()) {
            System.out.println("MysqlHandshakePacket capability.isSecureConnection()");
        ...
        if (capability.isPluginAuth()) {
            System.out.println("MysqlHandshakePacket last");
